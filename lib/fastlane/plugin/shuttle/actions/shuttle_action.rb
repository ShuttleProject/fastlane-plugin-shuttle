      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :app_name,
                                  env_name: "SHUTTLE_APP_NAME",
                               description: "The name of the app to publish the build to (if not provided, it will try to guess it or ask to select/create it interactively)",
                                  optional: true,
                                      type: String),
